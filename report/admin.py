...
class AdminReportType(admin.ModelAdmin):
    ...
    def add_view(self, request, form_url="", extra_context=None):
        ...
        return super(AdminReportType, self).add_view(request, form_url, extra_context = extra_context)
    ...
    def change_view(self, request, object_id, extra_context=None):
        ...
        return super(AdminReportType, self).change_view(request, object_id, extra_context = extra_context)
